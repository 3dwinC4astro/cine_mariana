                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    @if($pelicula->trailer)
                                        ...
                                        @endphp
                                        @if($videoId)
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#trailerModal{{ $pelicula->id }}">Ver Trailer</a>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="trailerModalLabel{{ $pelicula->id }}">Tráiler de {{ $pelicula->nombre }}</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <iframe width="100%" height="315" src="{{ 'https://www.youtube.com/embed/' . $videoId }}" title="{{ 'Tráiler de ' . $pelicula->nombre }}" frameborder="0" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
